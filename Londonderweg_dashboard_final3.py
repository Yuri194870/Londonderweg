...
# Functie om afbeeldingen correct van een URL te laden
...
ns_logo_base64 = get_image_base64("https://github.com/Yuri194870/Londonderweg/blob/main/NS_logo.png?raw=true")
if ns_logo_base64:
    st.markdown(
        f"""
...
with tab1:
    ...
    ov_fiets_base64 = get_image_base64("https://github.com/Yuri194870/Londonderweg/blob/main/OV_fiets_foto.jpg?raw=true")
    st.markdown(f'''
