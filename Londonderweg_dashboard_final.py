...
londenweer = pd.read_csv('londenweer.csv')
aantal_ritten_per_maand = pd.read_csv('aantal_ritten_per_maand.csv')
gemiddelde_duur_per_maand= pd.read_csv('gemiddelde_duur_per_maand.csv')
metropredict = pd.read_csv('metrokaart.csv')
...
# Dataset inlezen
fietsweerdata = pd.read_csv('fietsweerdata.csv')
...
with tab3:
    ...
    # %%
    london_station_locaties = gpd.read_file('London stations.json')
    ...
    # %%
    metrodata = pd.read_csv('TfL_stations.csv')
